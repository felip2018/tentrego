    ...
    <div class="container">
      ...
      <div class="body_message">
        <div>
          ...
          <p>
            Hola, {{nombre}}<br>
            <b>Click Store</b> te informa que tu cuenta ha sido bloqueada debido a un intento de violación de seguridad, para establecer el estado de tu cuenta te recomendamos que hagas una actalización de tu clave de acceso siguiendo el enlace que mostramos a continuación:
          </p>
        </div>
        <div>
