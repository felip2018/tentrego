...
<head>
  ...
  <title>Contacto Sitio Web</title>
...
<body>
    <div class="container">
      ...
      <div class="body_message">
        <div>
          <h3>CONTACTO DESDE SITIO WEB</h3>
          <p>Hola, un cliente se ha puesto en contacto a traves del sitio web de <b>Click Store</b></p> 
        </div>
        <div>
          <p>Datos de contacto</p>
          <table class="table">
            <tr>
              <td style="width: 40%;"><b>NOMBRE</b></td><td>{{nombre}}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td><b>MENSAJE</b></td><td>{{mensaje}}</td>
            </tr>
          </table>
        </div>
      </div>
