    ...
    <div class="container">
      ...
      <div class="body_message">
        <div>
          <h3>NUEVO CASO</h3>
          <p>
            Hola, {{nombre_admin}}<br>
            El cliente {{nombre_usuario}} ha generado un nuevo caso de <b>{{caso}}</b>, a continuación te informamos sobre el caso.
          </p>
        </div>
        <div>
          <p>Datos del caso</p>
          <table class="table">
            <tr>
              <td style="width: 40%;"><b>CLIENTE</b></td><td>{{nombre_usuario}}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td><b>PEDIDO #</b></td><td>{{id_pedido}}</td>
            </tr>
            <tr>
              <td><b>CODIGO DEL PEDIDO</b></td><td>{{codigo_pedido}}</td>
            </tr>
          </table>
        </div>
      </div>
