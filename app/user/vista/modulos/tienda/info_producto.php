<?php
	...
	$info = new InfoCon();
	$producto = $info -> infoProductoCon($_POST['id_producto']);
	$imagenes = $info -> imagenesProductoCon($_POST['id_producto']);
...
?>
		<div class="col-xs-12 col-md-12">
			<button class="btn btn-primary" type="button" onclick="loadPage('tienda')">
			...
			<div class="row p-5">
				<div class="col-xs-12 col-md-6 text-left">
					...
					<button class="btn btn-success" onclick="info_agregar_al_carrito('<?php echo $id_producto;?>','<?php echo $nombre_producto;?>','<?php echo $venta;?>','<?php echo $imagen;?>')">
				  	...
				  	<hr>
					<img class="card-img-top view_img" src="../adm/vista/modulos/productos/imagenes/<?php echo $producto['imagen'];?>" alt="<?php echo $producto['nombre'];?>">
					...
					?>
							<div class="imagenes_mini" style="width: 100%;/*border: 1px solid red;*/ height: auto;padding: 10px;overflow-x: scroll;">
								<?php
									...
									{
								?>
										<img src="../adm/vista/modulos/productos/imagenes/<?php echo $imagen['imagen'];?>" alt="<?php echo $imagen['imagen'];?>" width="150px" height="150px" onclick="ver_imagen('<?php echo $imagen['imagen'];?>')">
								<?php
									}
								?>
							</div>
