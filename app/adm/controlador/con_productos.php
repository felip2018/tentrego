					...
					<div class="col-xs-12 col-md-3">
						<div class="contenedor_producto">
							<div class="card-body">
						  	...
						  	<img class="card-img-top" src="vista/modulos/productos/imagenes/<?php echo $imagen;?>" alt="<?php echo $producto['nombre'];?>" width="100%" height="auto">
						  	<table>
								<tr>
									<td>
					...
					<div class="col-xs-12 col-md-3">
						<div class="contenedor_producto">
							<div class="card-body">
						  	...
						  	<img class="card-img-top" src="vista/modulos/productos/imagenes/<?php echo $producto['imagen'];?>" alt="<?php echo $producto['nombre'];?>" width="100%" height="auto">
						  	<table>
								<tr>
									<td>
										<button type="button" class="btn btn-primary float-left" onclick="editar_producto('<?php echo $producto['id_producto'];?>')"><i class="fa fa-edit"></i> Editar</button>			
